...
// string id = 1;
inline void C_GET_FRIEND::clear_id() {
  id_.ClearToEmpty();
}
inline const std::string& C_GET_FRIEND::id() const {
  // @@protoc_insertion_point(field_get:Protocol.C_GET_FRIEND.id)
  return _internal_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void C_GET_FRIEND::set_id(ArgT0&& arg0, ArgT... args) {
 
 id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Protocol.C_GET_FRIEND.id)
}
inline std::string* C_GET_FRIEND::mutable_id() {
  // @@protoc_insertion_point(field_mutable:Protocol.C_GET_FRIEND.id)
  return _internal_mutable_id();
}
inline const std::string& C_GET_FRIEND::_internal_id() const {
  return id_.Get();
}
inline void C_GET_FRIEND::_internal_set_id(const std::string& value) {
  
  id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* C_GET_FRIEND::_internal_mutable_id() {
  
  return id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* C_GET_FRIEND::release_id() {
  // @@protoc_insertion_point(field_release:Protocol.C_GET_FRIEND.id)
  return id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void C_GET_FRIEND::set_allocated_id(std::string* id) {
  if (id != nullptr) {
  ...
  id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), id,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:Protocol.C_GET_FRIEND.id)
}
